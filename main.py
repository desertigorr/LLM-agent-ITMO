...
def query_llm(query, sources):
    ...
    Если вопрос поставлен некорректно, ответь ТОЛЬКО "-1"
    Если на вопрос нельзя дать уверенный однозначный ответ (нет информации в источнике или в твоей базе данных) - ответь ТОЛЬКО "-1"
